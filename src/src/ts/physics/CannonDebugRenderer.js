...
CannonDebugRenderer.prototype = {
        ...
        for (var i = 0; i !== bodies.length; i++) {
            ...
            for (var j = 0; j !== body.shapes.length; j++) {
                ...
                if(mesh){
                    ...
                    axe.position.copy( shapeWorldPosition );
                    axe.quaternion.copy( shapeWorldQuaternion );
                }
    ...
    _createMesh: function(shape){
        ...
        if(mesh){
            this._axesHelper.push( new THREE.AxesHelper( 1 ) ); 
            this.scene.add( this._axesHelper[this._axesHelper.length - 1] );
            this.scene.add(mesh);
        }
